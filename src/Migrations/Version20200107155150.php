 ...
 */
final class Version20200107155150 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reply CHANGE user_id person_surveyed_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reply CHANGE person_surveyed_id user_id INT DEFAULT NULL');
